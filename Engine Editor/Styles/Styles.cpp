...
void Styles::Init(IcePick::EngineAPI& engineAPI) {
	...
	m_IconTextures[ICON_STATIC_MESH_ASSET] = engineAPI.NewTexture("res/textures/icons/cube_icon.png");
	m_IconTextures[ICON_MATERIAL_ASSET] = engineAPI.NewTexture("res/textures/icons/globe_icon.png");
}
