...
namespace IcePick {
	...
	public:
		...
		UUID NewMaterialInstanceFromScene(const aiScene* scene, unsigned int materialIndex, TextureLoader& textureLoader, const ImportSettings& importSettings);
	...
	private:
		...
		UUID m_LoadSkinnedMeshMaterialBaseId = UUID::Unitialised();
